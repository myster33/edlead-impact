...
import { Loader2, Lock, Mail, Moon, Sun, Eye, EyeOff, School } from "lucide-react";
import { z } from "zod";
...
export default function SchoolLogin() {
  ...
  const { signIn, user, isAuthenticated, isLoading: authLoading } = useSchoolAuth();
        ...
        <CardContent>
          <Tabs value={activeTab} onValueChange={setActiveTab}>
            <TabsList className="grid w-full grid-cols-2 mb-6">
              ...
              <TabsTrigger value="info">Register</TabsTrigger>
            </TabsList>
              ...
              <form onSubmit={handleSignIn} className="space-y-4">
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input id="login-email" type="email" placeholder="admin@school.edu" value={email} onChange={e => setEmail(e.target.value)} className="pl-10" disabled={isLoading} />
                  </div>
              ...
              <div className="space-y-4 text-center">
                <div className="p-4 bg-primary/10 rounded-lg">
                  ...
                  <p className="text-sm text-muted-foreground">
                    To register your school on edLEAD, please contact the edLEAD administration team. Once your school is verified, you will receive login credentials.
                  </p>
                </div>
