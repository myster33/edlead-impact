  ...
  const onSubmit = async (data: StoryFormData) => {
    if (!popiaConsent) {
      toast({
        ...
        description: "Please accept the Terms & Conditions to submit your story.",
        variant: "destructive",
      });
      return;
    }
      ...
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit(onSubmit, () => {
          ...
          <div className="space-y-4 border border-border rounded-lg p-4 bg-muted/30">
            <div className="flex items-start gap-3">
              ...
              <div className="space-y-1">
                ...
                <p className="text-xs text-muted-foreground">
                  By checking this box, I consent to edLEAD collecting, storing, and processing my personal information including my name, email, story content, and any photos/videos I submit, in accordance with the Protection of Personal Information Act (POPIA).{" "}
                  <button
                    type="button"
          ...
          <div className="flex justify-end gap-3">
            ...
            <Button type="submit" disabled={isSubmitting || isUploadingImage || !popiaConsent}>
              ...
              <div className="space-y-6 text-sm">
                <section>
                  ...
                  <p className="text-muted-foreground">
                    When you submit a story, we collect: your full name, email address, school name, 
                    country and province/region, your story content including any photos or videos you provide, 
                    and your edLEAD Captain reference number.
                  </p>
                </section>

                <section>
                  <h3 className="font-semibold text-base mb-2">2. Purpose of Data Collection</h3>
                  <p className="text-muted-foreground">Your information is collected to:</p>
                ...
                <section>
                  <h3 className="font-semibold text-base mb-2">3. Use of Photos, Stories & Media</h3>
                  <p className="text-muted-foreground">By submitting your story, you grant edLEAD permission to:</p>
                  <ul className="list-disc list-inside text-muted-foreground mt-2 space-y-1">
                    <li>Publish your story and accompanying media on our website and blog</li>
                    <li>Share your story on our social media platforms</li>
                    <li>Use your story in promotional and educational materials</li>
                    <li>Include your story in programme reports and presentations</li>
                    <li>Edit your submission for clarity while maintaining the essence of your story</li>
                  </ul>
                </section>

                <section>
                  <h3 className="font-semibold text-base mb-2">4. Email Communications</h3>
                  <p className="text-muted-foreground">
                    Your email address will be used to notify you about your submission status (approved/rejected), 
                    send confirmation of your submission, and communicate any questions about your story. 
                    We will not add you to marketing lists without separate consent.
                  </p>
                </section>

                <section>
                  <h3 className="font-semibold text-base mb-2">5. Your Rights Under POPIA</h3>
                  <p className="text-muted-foreground">You have the right to:</p>
                  <ul className="list-disc list-inside text-muted-foreground mt-2 space-y-1">
                    <li>Request access to your personal information</li>
                    <li>Request correction of inaccurate information</li>
                    <li>Request deletion of your story and personal data</li>
                    <li>Object to the processing of your information</li>
                    <li>Withdraw your consent at any time</li>
                  </ul>
                  <p className="text-muted-foreground mt-2">
                    To exercise these rights, contact us at info@edlead.org
                  </p>
                </section>
                ...
                <section>
                  ...
                  <p className="text-muted-foreground">
                    Your story and personal information will be retained for the duration of the edLEAD programme 
                    and for a reasonable period thereafter for archival and impact reporting purposes, 
                    unless you request deletion.
                  </p>
                </section>

                <section>
                  <h3 className="font-semibold text-base mb-2">7. Minor's Data Protection</h3>
                  <p className="text-muted-foreground">
                    If you are under 18 years of age, by submitting this story you confirm that you have obtained 
                    permission from your parent or legal guardian for edLEAD to collect and use your personal 
                    information as described in these terms.
                  </p>
                </section>
              </div>
            </ScrollArea>
