...
const routes = [
  ...
  },
  {
    ...
    description: 'Learn how edLEAD protects and handles your personal information. Our privacy policy covers data collection, usage, and your rights under POPIA.',
    ogTitle: 'Privacy Policy | edLEAD',
    ogDescription: 'Your privacy matters to us. Learn how edLEAD protects and handles your information.',
    canonical: `${SITE_URL}/privacy`,
    jsonLd: {
      '@context': 'https://schema.org',
      '@type': 'WebPage',
      name: 'Privacy Policy',
      description: 'edLEAD privacy policy covering data collection, usage, and rights under POPIA.',
  ...
  {
    path: '/terms',
    title: 'Terms of Use | edLEAD',
    description: 'Guidelines for participating in the edLEAD programme and using our services, including POPIA compliance information.',
    ogTitle: 'Terms of Use | edLEAD',
    ogDescription: 'Guidelines for participating in the edLEAD programme and using our services.',
    canonical: `${SITE_URL}/terms`,
    jsonLd: {
      '@context': 'https://schema.org',
      '@type': 'WebPage',
      name: 'Terms of Use',
      description: 'Terms and conditions for the edLEAD youth leadership programme.',
      url: `${SITE_URL}/terms`,
      isPartOf: { '@type': 'WebSite', name: 'edLEAD', url: SITE_URL },
    },
  },
  {
    path: '/check-status',
    title: 'Check Application Status | edLEAD',
    description: 'Check the status of your edLEAD programme application using your reference number.',
    ogTitle: 'Check Application Status | edLEAD',
    ogDescription: 'Track your edLEAD application status using your reference number.',
    canonical: `${SITE_URL}/check-status`,
    jsonLd: {
      '@context': 'https://schema.org',
      '@type': 'WebPage',
      name: 'Check Application Status',
      description: 'Check the status of your edLEAD programme application.',
